...
p1 = PhotoImage(file="C:\\Users\\arundhati\PycharmProjects\\icon.png")
# Setting icon of master window
root.iconphoto(False, p1)
bg = PhotoImage(file="C:\\Users\\arundhati\PycharmProjects\\weatherbg.png")
